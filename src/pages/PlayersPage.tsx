...
const PlayersPage = () => {
  ...
  const players: Player[] = [
    ...
    },
    {
      ...
      position: 'Portero',
      image: 'https://images.unsplash.com/photo-1599474924187-334a4ae5bd3c?w=300&h=300&fit=crop',
      tournaments: 15,
      goals: 0,
      assists: 2,
      progress: 92,
  ...
  const categories = ['all', 'Semillero', 'Iniciación', 'Formación', 'Desarrollo', 'Competencia'];
