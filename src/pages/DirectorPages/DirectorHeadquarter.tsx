...
import { MapPin, Building2, Plus, Edit, Trash2, Search } from "lucide-react";
 ...
 type HeadquarterStatus = "active" | "inactive" | "maintenance";
...
const DirectorHeadquarter = () => {
  const { user } = useAuth();
  const [headquarters, setHeadquarters] = useState<Headquarter[]>(mockHeadquarters);
  const [search, setSearch] = useState("");
  const [statusFilter, setStatusFilter] = useState<"all" | HeadquarterStatus>("all");
...
export default DirectorHeadquarter;
