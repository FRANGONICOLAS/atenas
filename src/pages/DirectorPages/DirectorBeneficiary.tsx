...
interface Beneficiary {
  ...
  medicalInfo: string;
  achievements?: { date: string; title: string; description: string }[];
}
  ...
  return (
    <div className="min-h-screen pt-20 bg-background">
      ...
      <DeleteConfirmation
        ...
        description="¿Estás seguro de eliminar este beneficiario? Esta acción no se puede deshacer."
...
export default DirectorBeneficiary;
