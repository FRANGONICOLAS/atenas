export const en = {
  ...
  home: {
    ...
    heroSubtitle:
      "Non-profit sports foundation dedicated to the comprehensive development of youth through football",
    ...
    problem: {
      ...
      description1:
        "Many young people live in vulnerable contexts: lack of opportunities, risk of school dropout, violence, addictions, or social exclusion. The absence of recreation and social support spaces deepens the problem, leaving young people without healthy alternatives for their free time.",
      description2:
        "In Comuna 17, although marked as economic stratum 4 to 5, most people do not have the purchasing power to pay for sports schools. Despite living in a high stratum, there are no resources to access formal sports plans, and many young people end up in risk situations.",
    ...
    transformation: {
      ...
      subtitle:
        "Sports generate a sense of belonging, discipline, mental health, and reduce vulnerability.",
      items: {
        belonging: { title: "Sense of Belonging", desc: "Building community" },
        emotions: {
          title: "Emotional Management",
          desc: "Transforming attitudes",
        },
        health: {
          title: "Physical and Mental Health",
          desc: "Prevention and well-being",
        },
    ...
    donationsUsage: {
      ...
      subtitle:
        "Donations are used to continue transforming lives through sports.",
      items: {
        equipment: {
          title: "Sports Equipment",
          desc: "For training and sports practice",
        },
        tournaments: {
          title: "Tournaments",
          desc: "Participation in sports competitions",
        },
        projects: {
          title: "Defined Projects",
          desc: "Donations dedicated to specific projects",
        },
      },
      bottomStart: "Every donation is a step",
      bottomEnd:
        " towards a more united, healthy, and future-oriented community.",
      transparency:
        "We work with total transparency. You can choose if your donation goes to a specific project or free investment.",
  ...
  about: {
    ...
    history: {
      ...
      items: {
        y2016: {
          title: "Foundation",
          desc: "We started with 20 children in a small neighborhood",
        },
        y2018: {
          title: "First Branch",
          desc: "We opened our first official branch",
        },
        y2020: {
          title: "Expansion",
          desc: "We reached 200 beneficiaries in 3 branches",
        },
        y2023: {
          title: "Recognition",
          desc: "National award for sports social impact",
        },
      },
    },
  },
  whatWeDo: {
    title: "What We Do",
    subtitle:
      "Discover the activities and programs we develop at the Sociodeportiva Atenas Foundation",
    training: {
      title: "Sports Training",
      description:
        "We develop structured training programs for all categories, from initiation to high performance.",
    },
    education: {
      title: "Academic Support",
      description:
        "We provide educational support to ensure our youth maintain good school performance.",
    },
    values: {
      title: "Values Formation",
      description:
        "We instill values such as respect, discipline, teamwork, and perseverance through sports.",
    },
    nutrition: {
      title: "Nutrition Program",
      description:
        "We provide balanced nutrition and nutritional education for the comprehensive development of our beneficiaries.",
    },
    tournaments: {
      title: "Tournament Participation",
      description:
        "We organize and participate in local, regional, and national tournaments to develop competitive skills.",
    },
    community: {
      title: "Community Work",
      description:
        "We carry out social integration activities and community work to strengthen ties with families and the environment.",
    },
    placeholders: {
  ...
  categories: {
    ...
    items: {
      sub6: {
        ...
        description:
          "Initiation to football through play. Development of basic motor skills and teamwork.",
        achievements: [
          "Participation in 5 local tournaments",
          "Training of 15 players for higher category",
        ],
      },
      sub8: {
      ...
      sub10: {
        ...
        description:
          "Development of technical football fundamentals. Introduction to basic game tactics.",
        achievements: [
          "Municipal tournament champions 2023",
          "8 players selected for departmental selection",
        ],
      },
      sub12: {
        ...
        description:
          "Technical and tactical improvement. Development of game vision and positioning.",
        achievements: [
          "Regional league runners-up",
          "12 called up for professional club trials",
        ],
      },
      sub14: {
        ...
        description:
          "Specialization by position. Specific physical preparation and mental development.",
        achievements: [
          "Participation in national tournaments",
          "5 players signed by professional academies",
        ],
      },
      sub16: {
        ...
        description:
          "High performance and preparation for professional football. Comprehensive athlete training.",
        achievements: [
          "3 players in professional club youth divisions",
  ...
  testimonials: {
    ...
    modal: {
      ...
      description:
        "Share your experience with the foundation. Your testimonial will be reviewed before publishing.",
      formTitle: "Title",
  ...
  donation: {
    ...
    destinationDescription:
      "Choose whether to donate to free investment or a specific project",
    generalFund: {
      title: "Free Investment",
      description:
        "Your donation will be used where it is needed most to support projects and beneficiaries of the foundation",
    },
    specificProject: {
    ...
    confirmSubtitle:
      "We will process your payment securely with Bold Payment Gateway",
    ...
    securePaymentDesc:
      "Your payment information is processed securely. We do not store card data.",
    ...
    terms:
      "By continuing, you agree that we will process your donation through Bold Payment Gateway",
    boldForm: {
      ...
      orderId: "Order ID:",
      confirmationMessage:
        "You will receive confirmation once the payment is completed.",
    ...
    results: {
      ...
      pending: {
        ...
        message:
          "Your payment is being processed. You will receive a confirmation email when completed.",
        button: "View my donations",
      },
      process: {
        title: "Processing...",
  ...
  evaluations: {
    ...
    addDesc: "Select the player and complete the necessary evaluations.",
    editTitle: "Edit Evaluation",
    editDesc: "Update the player's evaluation forms.",
    beneficiaryLabel: "Player",
    loadingBeneficiaries: "Loading players...",
    selectPlaceholder: "Select player",
    noBeneficiaries: "No players available",
    selectPrompt: "Select a player to enable evaluation forms.",
    tabs: {
    ...
    graphRadarTitle: "Parameter radar",
    graphLineTitle: "Historical progress",
    analysisParameters: "Parameter analysis",
    progressCardTitle: "Evaluation comparison",
    viewGraph: "View chart",
    scoreTrend: "Score trend %",
    previous: "Previous",
    current: "Current",
    historyTitle: "Records history",
    emptyEmotional: "No psychological-emotional evaluations",
  ...
  cta: {
    ...
    description:
      "Your support allows us to continue transforming lives through sports. Join our cause today!",
    button: "Donate Now",
  },
  donatorDashboard: {
    ...
    cards: {
      ...
      messages: {
        everyContribution:
          "Thank you for donating. Every contribution adds real momentum to this project.",
        goalCompleted:
          "Your support was part of the push that brought this project to its goal.",
        closeToGoal:
          "Your donation is helping this project get very close to its goal.",
        highImpact:
          "Your contribution had a strong impact on this project's progress.",
        growingImpact:
          "Your support keeps progress alive and opens new opportunities for more children.",
      },
    },
  },
};
